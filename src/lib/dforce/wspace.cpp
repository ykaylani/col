...
namespace wsforces {
    ...
    void g::apply(__m256& pbx, __m256& pby, __m256& pbz, const __m256& mas) {
    ...
    void airres::apply(__m256& pbx, __m256& pby, __m256& pbz, const __m256& velx, const __m256& vely, const __m256& velz, const __m256 rad) {
